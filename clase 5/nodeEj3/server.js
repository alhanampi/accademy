...
//newdate no refresca si lo pongo acá adentro directamente porqyue se crea una sola vez, por eso hago funcion:
...
http.createServer((req, res) => {
    ...
    console.log(req.url); //si pongo el req solo van a aparecer muchisimos datos, con el url solo me dice la petición esa en particular, que es el favicon.
    ...
    //res.write('<h1 style="color: maroon"> La hora actual es <span style="color:purple">' + new Date().toLocaleString() + '</span></h1>');
    res.end();
}).listen(app_port, err => {
